...
export const Card: React.FC<CardProps> = (props: CardProps) => {
  ...
  const firstLetter = props.first_name.charAt(0).toUpperCase();
      ...
      <Link href="/(modal)/modal" asChild>
        <View style={styles.cardContainer}>
          ...
          <View style={styles.textContainer}>
            <Text style={{ color: 'black', marginTop: 8 }}>{props.first_name} {props.last_name}</Text>
            <Text style={{ color: 'black', marginTop: 8 }}>{props.phone}</Text>
            <Text style={{ color: 'black', marginTop: 8 }}>{props.address}</Text>
          </View>
        </View>
      </Link>
    </TouchableOpacity>
